...
function drawListToDOM(): void {
    ...
    for (let index: number = 0; index < toDoTaskArray.length; index++) {
        ...
        todo.innerHTML = "<span class='check " + toDoTaskArray[index] + "'><i class='fas fa-check'></i></span>"
            + toDoTaskArray[index] +
...
function updateCounteropen(): void {
    ...
    for (var index: number = 0; index < toDoTaskArray.length; index++) {
        if (toDoTaskArray[index].todosChecked == false)
            counterOpen++;
    }
...
function updateCounterDone(): void {
    ...
    for (var index: number = 0; index < toDoTaskArray.length; index++) {
        if (toDoTaskArray[index].todosChecked == true)
            counterDone++;
    }
